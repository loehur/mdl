...
return [  
    ...
    'NOTA' => [
        'patterns' => [
            ...
            '/\b(yg|yang)\s+(saya|aku|kami)\s+(masukkan|antar|anter|serahkan|titip|bawa|nyerahkan|nitip)\s+(tadi|kemarin|kmrn|td)\b.{0,280}?\b(cuci|setrika|strika|reguler|regular|ekspres|ekspress|express|kilat|manual|laundry|loundry|londri)\b/iu',
            '/\b(yg|yang)\s+(saya|aku|kami)\s+(masukkan|antar|anter|serahkan|titip|bawa|nyerahkan|nitip)\b.{0,200}?\b(cuci|setrika|strika|reguler|regular|ekspres|ekspress|express|kilat|manual|laundry|loundry|londri)\b/iu',
            '/\b(kain|pakaian|cucian|baju|item)\s+(yang\s+)?(saya|aku|kami)\s+(antar|anter|masukkan|titip|bawa|nyerahkan|nitip)\b.{0,120}?\b(tadi|kemarin|kmrn|td)?\s*(pagi|siang|sore|malam)?\b.{0,200}?\b(cuci|setrika|strika|reguler|regular|ekspres|express|kilat|manual|laundry|loundry|londri)\b/iu',
            '/\b(saya|aku|kami)\s+(antar|anter|masukkan|titip|bawa|nyerahkan|nitip)\b.{0,80}?\b(tadi|kemarin|kmrn|td|pagi|siang|sore|malam|hari\s+ini)\b.{0,250}?\b(cuci\s*setrika|cuci\s*strika|setrika|strika|reguler|regular|ekspres|express|kilat)\b/iu',
        ...
        - Pola layanan: cuci setrika, setrika aja, reguler/regular, ekspres/express, kilat, manual, biasa, pilih yang ekspres, itu setrika aja.\n
