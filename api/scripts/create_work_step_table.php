...
try {
    $sql = "CREATE TABLE IF NOT EXISTS work_step (
    ...
    echo "✓ Table 'work_step' created successfully!\n";
    echo "\nColumns:\n";
    echo "- id (INT, AUTO_INCREMENT, PRIMARY KEY)\n";
    echo "- salon_id (VARCHAR 20, FOREIGN KEY to salon.salon_id)\n";
    echo "- name (VARCHAR 255) - Nama langkah kerja\n";
    echo "- fee (DECIMAL 10,2) - Biaya\n";
