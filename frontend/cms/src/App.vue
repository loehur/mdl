      ...
      >
        <div 
          ...
          :class="{
            ...
            'bg-purple-900/20 border-l-4 border-l-purple-500': activeChatId === chat.id && chat.priority,
            'border-l-4 border-l-transparent': activeChatId !== chat.id && !chat.priority,
            'border-l-4 border-l-purple-600 bg-purple-950/30': activeChatId !== chat.id && chat.priority
          }"
        >
           <div class="relative">
             <div 
