         ...
         <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
            ...
            <form @submit.prevent="createUser" class="p-6 grid gap-4">
                ...
                <div>
                   ...
                   <input v-model="form.phone_number" type="tel" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-fuchsia-200 focus:border-fuchsia-400 outline-none transition" required placeholder="Contoh: 0812..." />
                </div>
