          ...
          <form class="space-y-5" @submit.prevent="onSubmit">
            <div>
              ...
              <div class="relative group">
                ...
                <input v-model="id_user" class="w-full pl-12 pr-4 py-4 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-pink-500/10 focus:border-pink-500 outline-none transition-all bg-white/50 font-medium" type="email" placeholder="contoh@email.com" required />
              </div>
            </div>
