  ...
  routes: [
    ...
    // User Area Routes wrapped in Layout
    {
      ...
      children: [
        ...
        { path: "inventory-prices", component: () => import("./user_area/InventoryPrices.vue"), meta: { requiresAdmin: true } },
        { path: "inventory-input", component: () => import("./user_area/InventoryInput.vue"), meta: { requiresAdmin: true } },
        { path: "profit-loss", component: () => import("./user_area/ProfitLoss.vue"), meta: { requiresAdmin: true } },
