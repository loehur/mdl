      ...
      <div class="max-w-5xl mx-auto p-4 space-y-4">
        <section class="card space-y-3">
          ...
          <form v-if="showCreate" class="space-y-4 rounded-xl border border-accent/20 bg-ink-950/40 p-4" @submit.prevent="createTemplate">
            ...
            <div><label class="label block mb-1">Kategori</label><select v-model="createForm.category" class="field block w-full"><option value="UTILITY">Utility — notifikasi/transaksi</option><option value="MARKETING">Marketing — promosi</option><option value="AUTHENTICATION">Authentication — kode/login</option></select></div>
