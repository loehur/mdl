                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        <h6 class="text-uppercase text-muted mb-3" style="letter-spacing: 1px; font-size: 12px;">
                            <i class="fas fa-download me-2"></i>Unduhan Tools Perangkat
                        </h6>
                        <div class="border rounded-3 p-3 h-100 bg-light">
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <a href="<?= URL::IN_ASSETS ?>files/windows-kasir-debloat-full.bat" class="btn btn-primary btn-sm" download="windows-kasir-debloat-full.bat">
                                        <i class="fas fa-download me-1"></i> Download Windows Debloat
                                    </a>
                                </div>
                            </div>
                        </div>
